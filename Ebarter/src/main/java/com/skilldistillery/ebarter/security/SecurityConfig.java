package com.skilldistillery.ebarter.security;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
	    String userQuery = "SELECT user_name, password, enabled FROM user WHERE user_name=?";
	    String authQuery = "SELECT user.user_name, role.name FROM user JOIN role ON user.role_id = role.id WHERE user_name=?";
	    auth
	      .jdbcAuthentication()
